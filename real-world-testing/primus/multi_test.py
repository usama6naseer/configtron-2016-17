					...
					for loss in loss_array:
						...
						for prot in prot_array:
							...
							for cwnd in cwnd_array:
								...
								if resume_flag == 0:
									try:
										fo = open('amazon_plt_record.csv')
										csvfileo = csv.reader(fo)
										for rowo in csvfileo:
											# print rowo
											if (str(rowo[1]) == str('http://152.3.144.154/replay/www.amazon.com')):
												# print(1)
								...
								if resume_flag == 1:
									...
									for load_time in range(0,5):
										try:
											continue_flag = 1
											site = "http://152.3.144.154/replay/www.netflix.com"
											print "loaded for:", load_time, site
											end_time = 0
											start_time = 0
											# socket.setdefaulttimeout(120000)
											...
											if continue_flag == 1:
												try:
													...
													arr.append(bw)
													arr.append(str(datetime.now()))
													filename = "netflix_plt_record.csv"
													c = csv.writer(open(filename, "a"))
													c.writerow(arr)
													print "results written to %s.csv"%(filename)
													time.sleep(1)
									...
									for load_time in range(0,5):
										try:
											continue_flag = 1
											site = "http://152.3.144.154/replay/www.ebay.com"
											print "loaded for:", load_time, site
											end_time = 0
											start_time = 0
											# socket.setdefaulttimeout(120000)
									...
									for load_time in range(0,5):
										try:
											continue_flag = 1
											site = "http://152.3.144.154/replay/www.amazon.com"
											print "loaded for:", load_time, site
											end_time = 0
											start_time = 0
											# socket.setdefaulttimeout(120000)
											...
											if continue_flag == 1:
												try:
													...
													arr.append(bw)
													arr.append(str(datetime.now()))
													filename = "amazon_plt_record.csv"
													c = csv.writer(open(filename, "a"))
													c.writerow(arr)
													print "results written to %s.csv"%(filename)
													time.sleep(1)
									...
									# 	try:
									# 		continue_flag = 1
									# 		print "object loaded for:", load_time
									# 		end_time = 0
									# 		start_time = 0
									# 		# socket.setdefaulttimeout(120000)
									# 		try:
									...
									# 			try:
									# 				plt = end_time - start_time
									# 				print("object plt:", plt)

									# 				arr = []
									# 				arr.append(load_time)
									# 				arr.append("5mb image")
									# 				arr.append(plt)
									# 				arr.append(cwnd)
									# 				arr.append(prot)
									# 				arr.append(loss)
									...
									# 				arr.append(bw)
									# 				arr.append(str(datetime.now()))
									# 				c = csv.writer(open("object_load_record.csv", "a"))
									# 				c.writerow(arr)
									# 				print "results written to object_load_record.csv"
									# 				time.sleep(1)
